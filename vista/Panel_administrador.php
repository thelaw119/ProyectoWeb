                    ...
                    <nav class="mt-2">  
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false"> 
                            ...
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item" id="x">
                                        <a href="#" onclick="javascript:verusuarios();" class="nav-link">
                                            <i class="far fa-primary nav-icon"></i>
                                            <p>Ver Usuarios</p>
                                        </a>
                                    </li>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-6">
                                ...
                                foreach ($data as $row) {
                                    ...
                                    <a href="#" onclick="javascript:gestionproducto();" class="small-box-footer">Mas Informacion <i class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-3 col-6">
                                ...
                                foreach ($data as $row) {
                                    ...
                                    <a href="#" onclick="javascript:gestioncategoria();" class="small-box-footer">Mas Informacion <i class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-3 col-6">
                            ...
                            <div class="col-lg-3 col-6">
                                <!-- small box -->
                                <?php
                                $SQL = "SELECT COUNT(*) FROM detalle_compra";
                                $resultado = mysqli_query($conexion, $SQL);
                                $data = $resultado->fetch_assoc();
                                foreach ($data as $row) {
                                    ?>
