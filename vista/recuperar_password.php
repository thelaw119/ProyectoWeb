...
<html>
    <head>
        ...
        <title>FUN GAMES | Recuperar Password</title>
        ...
        <div class="login-box">
            ...
            <div class="card">
                <div class="card-body login-card-body">
                    ...
                    <form >
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <button type="button" class="btn btn-primary" href="javascript:;" onclick="recupera_cuenta($('#email').val());return false;">Recupera Cuenta</button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
                    ...
                    <p class="mb-0">
                        <a href="registrar.php" class="text-center">Registra nueva cuenta</a>
                    </p>
                </div>
